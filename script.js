...
const printingTypeSelect =
document.getElementById("printingType");

const designSection =
document.getElementById("designSection");

function toggleDesignUpload() {

    if (!printingTypeSelect || !designSection) return;

    if (printingTypeSelect.value === "Plain") {
...
if (printingTypeSelect && designSection) {

    printingTypeSelect.addEventListener(
        "change",
        toggleDesignUpload
    );
