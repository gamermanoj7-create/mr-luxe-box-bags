...
// ===========================================
// MR LUXE COMPANY DETAILS
// ===========================================

const COMPANY = {
  name: "MR Luxe Box & Bags",
  tagline: "Premium Jewellery Packaging Manufacturer",
  owner: "Manoj Roy",
  phone: "+91 9932650608",
  email: "info@mrluxeboxbags.com",
  website: "https://gamermanoj7-create.github.io/mr-luxe-box-bags/",
  address: "Kalyani, Nadia, West Bengal, India",
  gst: "Not Registered"
};
...
function downloadInvoice() {
    ...
    doc.text("Mobile : " + order.phone, 20, 70);
...
order.products.forEach((item, index) => {
    ...
    doc.text(
        "Thank you for shopping with MR Luxe Box & Bags.",
        20,
        y
    );
