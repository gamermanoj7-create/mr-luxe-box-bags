...
window.placeOrder = async function () {
    ...
    try {
        ...
        localStorage.setItem(
            "lastOrder",
            JSON.stringify(Object.assign({}, orderData, { orderId: docRef.id, createdAt: undefined }))
        );
        ...
        alert(
            ...
            "\n\nYou can track this order anytime on the My Orders page using your mobile number, or download the invoice from there."
        );
